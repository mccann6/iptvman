...
<div class="min-h-screen bg-base-200">
    <div class="container mx-auto p-4">
        ...
        <div class="navbar bg-base-100 rounded-box shadow-lg mb-6">
            <div class="flex-1">
                <h1 class="text-3xl font-bold">📺 IPTVMan</h1>
            </div>
                    ...
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body">
                            ...
                            <div class="alert alert-info mb-2">
                                <div class="flex-1">
                                    <span class="text-xs font-semibold">IPTV URL:</span> 
                                    <code class="text-xs break-all">{window.location.origin}/{account.id}</code>
                                </div>
                                <button 
                                    class="btn btn-xs btn-ghost" 
                                    onclick={() => copyAccountUrl(account.id)}
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-base-content/70 flex-1">{account.username || 'Not set'}</span>
                                    {#if account.username}
                                        <button 
                                            class="btn btn-xs btn-ghost" 
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-base-content/70 flex-1">{account.password ? '••••••••' : 'Not set'}</span>
                                    {#if account.password}
                                        <button 
                                            class="btn btn-xs btn-ghost" 
